...
actual_water_shortage_level |>
  ...
  head(2)
```
** Add unique() to count how many diff labels there are (exclude numeric values)
...
###Issue 4: total water supply is less than to the total water produced 
[add content] (water purchased is included)
###Solution 4: improve initial self-reporting from water districts.
[add content]
