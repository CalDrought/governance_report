...
The Historical Production and Delivery Dataset shows the amount of water (acre-feet) from each water district that is produced for that district and supplied by that district. This information is separated by water type. 
...
ideal solution
find correct input and replace numbers
