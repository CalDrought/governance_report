...
This issue focuses on the `pwsid` column and where values are either `NA` or not the correct 9 character length. Once again, the following will identify rows that have these discrepanices.
